...
export const slides = [
  <div>
    ...
    <p>
      <code>top: <i>*value*</i>px;</code>
    </p>
    <code>left: <i>*value*</i>px;</code>
  </div>,
  <div>
    <p>.vase</p>
    <StyledVase
...
-40 0 0 -83z"
    ...
    <code>fill: <i>*color*</i>;</code>
  </div>,
  <div>
    <p>.clock</p>
    <StyledClock src={clockUrl} className="clock" />
    <code>transform: rotate(<i>*value*</i>deg);</code>
  </div>,
  <div>
    <p>.picture</p>
    <StyledPicture src={pictureUrl} className="picture" />
    <code>transform: scale(<i>*size*</i>);</code>
  </div>,
  <div>
    <p>.cactus</p>
    <StyledCactus src={cactusUrl} className="cactus" />
    <code>transform: scale(<i>*sx*</i>, <i>*sy*</i>);</code>
  </div>,
  <div>
    <p>.room</p>

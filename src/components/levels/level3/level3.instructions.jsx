...
export const instructions = [
  ...
  <p>Step 1: create references for all fields (lines 12-18).</p>,
  <p>Step 2: add ref attributes for all input tags (lines 32-61).</p>,
  <p>Step 3: finish logic inside applyFormData method (lines 20-29) using functions from lines 4-10.</p>,
